...
public class CharacterInfoScreenBuilder implements Builder<Region> {
  ...
  public Region build() {
    ...
    TextField nameField = Widgets.createTextField("Name..", model.name(), "character-info-text-field");
    Label appearance = Widgets.createLabel("What do you look like?", "character-info-label");
    TextField appearanceField = Widgets.createTextField("Appearance..", model.appearence(),
